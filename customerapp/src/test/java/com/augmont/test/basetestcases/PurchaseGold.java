...
public class PurchaseGold extends BaseTest{
	...
	{	
		...
		paymentMethod.makePaymentViaNetBanking();
	}
	
	@Test()
	public void buyGold_ValidateOrder_TC001()
	{	
		...
		purchaseMethod.verifyPurchaseSummaryForWallet();
	...
	@Test
	public void buyGold_ValidateOrder_TC003()
	{	
	...
	@Test
	public void buyGold_ValidateOrder_TC004()
	{	
	...
	//	goldPurchaseAPI.getGoldRates();
		...
		paymentMethod.paymentMethodUsingUPI();
		transactionMethod.validateWalletAmountForPartialPayment();
