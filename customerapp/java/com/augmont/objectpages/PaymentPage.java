...
public class PaymentPage extends BaseTest {	
	...
	By cardMonthEle=AppiumBy.xpath("//android.widget.EditText[@resource-id='selMonth']");
	By expiryField=AppiumBy.xpath("//input[@name=\"card.expiry\"]");
	...
	By verifyUPIIDele=AppiumBy.xpath("//android.widget.TextView[@text='VERIFY UPI ID']");
	By verifyUPIIDSuccessEle=AppiumBy.xpath("//android.widget.TextView[@text='Dummy User']");
	
	public void clickOnAmanteButton()
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(amanteBtn));
		driver.findElement(amanteBtn).click();
	    Reporter.log("Click Perofom On Emandate button SuceessFully",true);
	    extentTestChild.info("Click Perofom On Emandate button SuceessFully");
	}
	...
	public void clickOnCardOption()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
		    ...
		    driver.findElement(clickOnCardOption)
		);
			wait.until(ExpectedConditions.elementToBeClickable(element));
		element.click();   
	    Reporter.log("Click Perform On Card Radio button SuceessFully",true);
	    extentTestChild.info("Click Perform On Card Radio button SuceessFully");
	}
	...
	public void waitForDefaultUpiOptionToBeVisible()
	{
	  ...
	  wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("//android.view.View[@text='Payment Options']")));
		try {
			Thread.sleep(500);
			...
			Reporter.log("Back Buttom Click Perform",true);
			extentTestChild.info("Back Buttom Click Perform");
...
public void clickOnNetBankingOption()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    ...
			    .ignoring(NoSuchElementException.class);        // Ignore exception			
			WebElement element = wait.until(driver ->
		    driver.findElement(netBankingOptionEle)
		);
			
		element.click();   
	    Reporter.log("Click Perofom On NetBanking Radio button SuceessFully",true);
	    extentTestChild.info("Click Perofom On NetBanking Radio button SuceessFully");
	}
	...
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(cardHolderName));
		driver.findElement(cardHolderName).sendKeys("test");
		Reporter.log("Card Holder Name is:",true);
		extentTestChild.info("Card Holder Name is:");

	}
	
	public void enterCardHolderNameRazorPay(String name)
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(cardHolderNameRazorPay));
		driver.findElement(cardHolderNameRazorPay).sendKeys(name);
		Reporter.log("Card Holder Name is:"+name,true);
		extentTestChild.info("Card Holder Name is:"+name);

	}

	public void enterEmailIDRazorPay(String name)
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(emailIDRazorPay));
		driver.findElement(emailIDRazorPay).sendKeys(name);
		Reporter.log("Email ID is:"+name,true);
		extentTestChild.info("Email ID is:"+name);

	}


	
	public void enterExpiryDateCard() {
	    LocalDate expiry = LocalDate.now().plusMonths(1).plusYears(1);
	    String month = expiry.format(DateTimeFormatter.ofPattern("MM"));
	    String year = expiry.format(DateTimeFormatter.ofPattern("yy"));
	    driver.findElement(cardMonthEle).sendKeys(month);
	    driver.findElement(cardYearEle).sendKeys(year);
	}
	
	public void enterExpiryDateCardRazorPay() {
	    LocalDate expiry = LocalDate.now().plusMonths(1).plusYears(1);
	    String month = expiry.format(DateTimeFormatter.ofPattern("MM"));
	    String year = expiry.format(DateTimeFormatter.ofPattern("yy"));
	    driver.findElement(expiryField).sendKeys(""+month+"/"+year+"");
	    
	}

	public void enterCVVNumber() throws IOException
	{
		 prop = new Properties();
		FileInputStream fis;
		try {
	...
	public void enterCVVNumberRazorPay() throws IOException
	{
		 prop = new Properties();
		FileInputStream fis;
		try {
	...
	public void clickOnPayButton()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    ...
			    .ignoring(NoSuchElementException.class);        // Ignore exception			
			WebElement element = wait.until(driver ->
		    driver.findElement(payClick)
		);
			wait.until(ExpectedConditions.elementToBeClickable(payClick));
			element.click();
	    Reporter.log("Click Perform On Pay Button",true);
		extentTestChild.info("Click Perform On Pay Button");

	}

	public void clickOnSucessCardButton()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    ...
			    .ignoring(NoSuchElementException.class);        // Ignore exception			
			WebElement element = wait.until(driver ->
		    driver.findElement(sucessClickCard));

		wait.until(ExpectedConditions.elementToBeClickable(sucessClickCard));
		element.click();
	...
	public void clickOnSubmitCardButton()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    ...
			    .ignoring(NoSuchElementException.class);        // Ignore exception			
			WebElement element = wait.until(driver ->
		    driver.findElement(submitClickCard)
		);
			wait.until(ExpectedConditions.elementToBeClickable(submitClickCard));
			element.click();

	    Reporter.log("Click Perform On  Submit Button",true);
		extentTestChild.info("Click Perform On Submit Button");
	...
	public void clickOnNetBankingBtn()
	{
		  wait.until(ExpectedConditions.visibilityOfElementLocated(netBankingBtn));
...
//	        System.out.println("Clicking on Continue button: " + continueBtn.getText());
//	        continueBtn.click();
//		    driver.findElement(defaultGoBack).click();	
//	        Reporter.log("Click Performed on RazorPay Continue Button", true);
//	        extentTestChild.info("Click Performed on RazorPay Continue Button");
//
//	    } catch (Exception e1) {
...
//
//	            WebElement netbankingOption = driver.findElement(netBankingBtnRazorPay);
//	            wait1.until(ExpectedConditions.elementToBeClickable(netBankingBtnRazorPay));
//	            System.out.println("Clicking on Netbanking option: " + netbankingOption.getText());
//	            netbankingOption.click();
//	            Reporter.log("Click Performed on Netbanking  Option", true);
//	            extentTestChild.info("Click Performed on Netbanking  Option");
//
//	        } catch (Exception e2) {
//	            System.out.println("Neither Continue button nor Netbanking option found!");
//	            Reporter.log("Failed: Could not click RazorPay option", true);
//	            extentTestChild.fail("Failed: Could not click RazorPay option");
//	            throw e2; // rethrow so the test fails in TestNG
//	        }
...
//	
	...
	public void getToastMessageoneTimeBuyMetal(String congtmsg,String sucessmsg){
		...
		By goldMessage = AppiumBy.xpath("//*[contains(@content-desc, 'successfully bought')]");
	...
	public void clickOnPayNowBtn()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(PayNowele)
			);
			element.click();
	    Reporter.log("Click Perform on PayNow Button",true);
	    extentTestChild.info("Click Perform on PayNow Button");    
	}	
	
	public void clickOnJioMoney()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    .withTimeout(Duration.ofSeconds(50))             // Total wait time
			    .pollingEvery(Duration.ofMillis(500))             // Polling interval
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(jioMoneyEle)
			);
			element.click();
	    Reporter.log("Click Perform on JioMoney Payment Options",true);
	    extentTestChild.info("Click Perform on JioMoney Payment Options");
	}
	...
	public void clickOnContinueRazorPay()
	{
        ...
        WebElement element;
        try {
            element = wait.until(d -> d.findElement(continueBtnRazorPay));
	...
	public void clickOnContinueRazorPayAfterEnterOTP()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(continueBtnRazorPayAfterEnterOtpEle)
			);
			element.click();
	...
	public void clickOnMaybeLaterButton()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(mayBeLater)
			);
			wait.until(ExpectedConditions.elementToBeClickable(element));
		element.click();
	    Reporter.log("Click Perform on MayBeLater Button",true);
	    extentTestChild.info("Click Perform on MayBeLater Button");
	}
	
	


	public void enterOtpRazorPay(String otp) {
	    ...
	    // Count OTP input fields using XPath
	    Long inputCount = (Long) js.executeScript(
	        "return document.evaluate(\"count(//input[@name='otp'])\", document, null, XPathResult.NUMBER_TYPE, null).numberValue;"
	    );

	    if (inputCount == 1) {
	        // Single field OTP
	        js.executeScript(
	            "var el = document.evaluate(\"//input[@name='otp']\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;" +
	            "el.value='" + otp + "';" +
	            "el.dispatchEvent(new Event('input', { bubbles: true }));"
	        );
	    } else if (inputCount > 1) {
	        // Multiple boxes OTP
	        for (int i = 0; i < otp.length() && i < inputCount; i++) {
	            String script = 
	                "var el = document.evaluate(\"(//input[@name='otp'])[" + (i+1) + "]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;" +
	                "el.value='" + otp.charAt(i) + "';" +
	                "el.dispatchEvent(new Event('input', { bubbles: true }));";
	            js.executeScript(script);
	        }
	    } else {
	        throw new RuntimeException("No OTP input fields found using //input[@name='otp']");
	    }
	}
	...
	public void verifyPaymentAmountOnPaymentPage(double expectedAmount) {
	    ...
	    BigDecimal actualAmount = new BigDecimal(cleanAmount).setScale(2, RoundingMode.DOWN);
	    ...
	    if (actualAmount.compareTo(expectedAmountBD) == 0) {
	        Reporter.log("✅ Payment Amount Verified on Payment Page: ₹" + actualAmount, true);
	        extentTestChild.pass("Payment Amount Verified on Payment Page: ₹" + actualAmount);
	    } else {
	        Reporter.log("❌ Payment Amount Mismatch on Payment Page. Expected: ₹" + expectedAmountBD + ", Found: ₹" + actualAmount, true);
	        extentTestChild.fail("Payment Amount Mismatch on Payment Page. Expected: ₹" + expectedAmountBD + ", Found: ₹" + actualAmount);
	    }
	}
	
	public void verifyPaymentAmountOnPaymentPageRazorPay(double expectedAmount) {
	    // Wait with FluentWait to locate the element
	    Wait<AndroidDriver> wait = new FluentWait<>(driver)
	    ...
	    WebElement element = wait.until(driver -> driver.findElement(paymentAmountRazorPayEle));
	...
	public void clickOnContinueAndPay()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    .withTimeout(Duration.ofSeconds(40))             // Total wait time
			    .pollingEvery(Duration.ofMillis(500))             // Polling interval
			    .ignoring(NoSuchElementException.class).ignoring(StaleElementReferenceException.class);          // Ignore exception
	...
	public void addWalletBalanceSucessMessage()
	{
		...
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(walletfundSucessMsg));
			wait.until(ExpectedConditions.visibilityOf(element));		
		String congmsg= element.getAttribute("content-desc");	
		if(congmsg.equals(walletFundSucessMsg))
		{
		Reporter.log("Wallet Add Fund Message is varified:"+congmsg,true);
		extentTestChild.pass("Wallet Add Fund Message is varified:"+congmsg);
		}
		else
		{
			Reporter.log("Wallet Add Fund Message is not varified:"+congmsg,true);
			extentTestChild.fail("Wallet Add Fund Message is not varified:"+congmsg);
			
		}
}
	
	public void getCardPaymentSucessMessage()
	{
				Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    .withTimeout(Duration.ofSeconds(50))             // Total wait time
			    .pollingEvery(Duration.ofMillis(500))             // Polling interval
		...
		if(element.getAttribute("content-desc").equals(congratulationMsg))
		{
			extentTestChild.pass("Payment Successful:"+congratulationMsg);
		}
		else
		{
			extentTestChild.fail("Payment Failed");
	...
	public void verifyFailureMessageNetBanking()
	{
		...
		if(element.getText().equals(failureMsgNetBanking))
		{
			extentTestChild.pass("Payment fail:"+"Expected:"+failureMsgNetBanking+ "Actutal:"+msg);
		}
		else
		{
			extentTestChild.fail("Payment failure message is not varified");
	...
	public void selectUPIRadioButton()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			...
			WebElement element = wait.until(driver ->
		    driver.findElement(upiIDSelecttionEle)
		);
		if(!element.isSelected())
		{
		element.click();   
	    Reporter.log("Click Perform On UPI Radio button SuceessFully",true);
	    extentTestChild.info("Click Perform On UPI Radio button SuceessFully");
		}
	}
	public void selectUPI(String upi)
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    .withTimeout(Duration.ofSeconds(40))             // Total wait time
			    .pollingEvery(Duration.ofMillis(500))             // Polling interval
	    ...
	    extentTestChild.info("Click Perform On UPI SuceessFully");		
	}

	public void enterUPINumber(String upiID)
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(upiTextBox));
		driver.findElement(upiTextBox).sendKeys(upiID);
		Reporter.log("UPI number is:"+upiID,true);
		extentTestChild.info("UPI number is:"+upiID);
	}

	public void clickOnVerifyUPIID()
	{
		Wait<AndroidDriver> wait = new FluentWait<>(driver)
			    .withTimeout(Duration.ofSeconds(40))             // Total wait time
			    .pollingEvery(Duration.ofMillis(500))             // Polling interval
			...
			WebElement element = wait.until(driver ->
		    driver.findElement(verifyUPIIDele)
		);
		element.click();   
	    Reporter.log("Click Perform On Verify UPI ID SuceessFully",true);
	    extentTestChild.info("Click Perform On Verify UPI ID SuceessFully");		
	}
	...
	public void verifyUPIIDSucessMessage()
	{
			...
			WebElement element = wait.until(driver ->
			    driver.findElement(verifyUPIIDSuccessEle));			
			wait.until(ExpectedConditions.visibilityOf(element));			
		if(element.getText().equals("Dummy User"))
		{
			extentTestChild.pass("UPI ID Verified SuccessFully");
		}
		else
		{
			extentTestChild.fail("UPI ID Not Verified SuccessFully");
